...
<!--[if !mso]>
<!-->
<body class="full-padding" style="margin: 0px; padding: 0px; text-size-adjust: 100%;">
<!--
<![endif]-->
					...
					<table align="center" class="preheader" cellpadding="0" cellspacing="0" role="presentation">
						<tr>
							<td style="width: 280px" valign="top">
								<![endif]-->
								<div class="snippet" style="display: table-cell;Float: left;font-size: 12px;line-height: 19px;max-width: 280px;min-width: 140px; width: 140px;width: calc(14000% - 78120px);padding: 10px 0 5px 0;color: #bdbdbd;font-family: Ubuntu,sans-serif;"></div>
								<!--[if (mso)|(IE)]>
							</td>
							<td style="width: 280px" valign="top">
								<![endif]-->
								<div class="webversion" style="display: table-cell;Float: left;font-size: 12px;line-height: 19px;max-width: 280px;min-width: 139px; width: 139px;width: calc(14100% - 78680px);padding: 10px 0 5px 0;text-align: right;color: #bdbdbd;font-family: Ubuntu,sans-serif;"></div>
								<!--[if (mso)|(IE)]>
							</td>
						</tr>
					</table>
						...
						<td style="width: 600px">
							...
							<div class="logo emb-logo-margin-box" style="font-size: 26px;line-height: 32px;margin-top: 6px;margin-bottom: 20px;color: #c3ced9;font-family: Roboto,Tahoma,sans-serif;margin-left: 20px;margin-right: 20px;" align="center">
								<div class="logo-center" align="center" id="emb-email-header">
									<img style="display: block;height: auto;width: 100%;border: 0;max-width: 336px;" src="{{asset('img/logo-shadow.png')}}" alt="" width="336">
									</div>
								</div>
								<!--[if (mso)|(IE)]>
							</td>
										...
										<div style="margin-left: 20px;margin-right: 20px;">
											<div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
												...
												<p style="margin-top: 20px;margin-bottom: 0;">&nbsp;
													<br>
														Lorem ipsum dolar sit amet Lorem ipsum dolar sit amet. Lorem ipsum dolar sit amet. orem ipsum dolar sit amet.Lorem ipsum dolar sit amet Lorem ipsum dolar sit amet.
													</p>
													<p style="margin-top: 20px;margin-bottom: 20px;"> Account: <strong> {{ $user->name }}</strong> </p>
													<p style="margin-top: 20px;margin-bottom: 20px;"> Amount: <strong> ${{ number_format( $transaction->amount ,2, '.', ',')  }} </strong> </p>
													<p style="margin-top: 20px;margin-bottom: 20px;"> Date: <strong> {{ date('F jS Y', strtotime($transaction->created_at)) }} </strong> </p>
												</div>
											</div>
											<div style="margin-left: 20px;margin-right: 20px;">
											...
											<div style="margin-left: 20px;margin-right: 20px;">
												<div class="btn btn--flat btn--large" style="margin-bottom: 20px;text-align: center;">
													<!--[if !mso]-->
													<a style="border-radius: 4px;display: inline-block;font-size: 14px;font-weight: bold;line-height: 24px;padding: 12px 24px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #ffffff !important;background-color: #80bf2e;font-family: Ubuntu, sans-serif;" href="{{config('app.url')}}" target="_blank">Visit Our Site</a>
													<!--[endif]-->
													<!--[if mso]>
													<p style="line-height:0;margin:0;">&nbsp;</p>
													<v:roundrect
														xmlns:v="urn:schemas-microsoft-com:vml" href="http://test.com" style="width:212px" arcsize="9%" fillcolor="#80BF2E" stroke="f">
														<v:textbox style="mso-fit-shape-to-text:t" inset="0px,11px,0px,11px">
															<center style="font-size:14px;line-height:24px;color:#FFFFFF;font-family:Ubuntu,sans-serif;font-weight:bold;mso-line-height-rule:exactly;mso-text-raise:4px">COMPLETE THE
																<br>
SURVEY
																</center>
															</v:textbox>
											...
											<td style="width: 400px;" valign="top" class="w360">
												...
												<div class="column wide" style="text-align: left;font-size: 12px;line-height: 19px;color: #bdbdbd;font-family: Ubuntu,sans-serif;Float: left;max-width: 400px;min-width: 320px; width: 320px;width: calc(8000% - 47600px);">
													<div style="margin-left: 20px;margin-right: 20px;margin-top: 10px;margin-bottom: 10px;">
														...
														<div style="font-size: 12px;line-height: 19px;margin-top: 20px;"></div>
