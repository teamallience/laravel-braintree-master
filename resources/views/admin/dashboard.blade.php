        ...
        <div class="card">
            <div class="card-body">
                ...
                <table class="table browser m-t-30 no-border">
                    <tbody>
                        <tr>
                            <td style="width:40px"><img src="{{asset('images/browser/chrome-logo.png')}}" alt="logo"></td>
                            <td>Google Chrome</td>
                            <td class="text-right">23%</td>
                        </tr>
                        <tr>
                            <td><img src="{{asset('images/browser/firefox-logo.png')}}" alt="logo"></td>
                            <td>Mozila Firefox</td>
                            <td class="text-right">15%</td>
                        </tr>
                        <tr>
                            <td><img src="{{asset('images/browser/safari-logo.png')}}" alt="logo"></td>
                            <td>Apple Safari</td>
                            <td class="text-right">07%</td>
                        </tr>
                        <tr>
                            <td><img src="{{asset('images/browser/internet-logo.png')}}" alt="logo"></td>
                            <td>Internet Explorer</td>
                            <td class="text-right">09%</td>
                        </tr>
                        <tr>
                            <td><img src="{{asset('images/browser/opera-logo.png')}}" alt="logo"></td>
                            <td>Opera mini</td>
                            <td class="text-right">23%</td>
                        </tr>
                        <tr>
                            <td><img src="{{asset('images/browser/netscape-logo.png')}}" alt="logo"></td>
                ...
                <div class="table-responsive m-t-20 no-wrap">
                    <table class="table vm no-th-brd pro-of-month">
                        ...
                        <tbody>
                            ...
                            <tr class="active">
                                <td><span class="round"><img src="{{asset('images/placeholder.jpg')}}" alt="user" width="50"></span></td>
                                <td>
        ...
        <div class="card">
            ...
            <div class="comment-widgets">
                ...
                <div class="d-flex flex-row comment-row">
                    <div class="p-2"><span class="round"><img src="{{asset('images/placeholder.jpg')}}" alt="user" width="50"></span></div>
            ...
            <div class="card-body">
                ...
                <div class="chat-box">
                    ...
                    <ul class="chat-list">
                        <!--chat Row -->
                        <li>
                            <div class="chat-img"><img src="{{asset('images/placeholder.jpg')}}" alt="user"></div>
