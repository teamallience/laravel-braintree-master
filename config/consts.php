...
return [
	'ADMIN' => [
		'SIDEBAR' => [
			...
			'APPS' => ['TITLE' => 'Apps', 'LOCATION' => 'admin.dashboard', 'ICON' => 'icon-Double-Circle', 'CHILDREN' => [
				...
				'SUPPORT_TICKET' => ['TITLE' => 'Support Ticket', 'LOCATION' => 'admin.dashboard'],
				'CONTACT_GRID' => ['TITLE' => 'Contact Grid', 'LOCATION' => 'admin.dashboard'],
				'CONTACT_EMPLOYEE' => ['TITLE' => 'Contact / Employee', 'LOCATION' => 'admin.dashboard'],
				'CONTACT_DETAIL' => ['TITLE' => 'Contact Detail', 'LOCATION' => 'admin.dashboard'],
			]],
		],
	],
	'CLIENT' => [
		'SIDEBAR' => [
			...
			'SETTINGS' => ['TITLE' => 'Settings', 'LOCATION' => 'client.settings', 'ICON' => 'icon-Gears-2'],
		],
		'HISTORY_PER_PAGE' => 5
	],
	'AUTOBILL' => [
	...
	'GLOPAL_PASSWORD' => 'hotdoghotdiggitydog1717',
	'COUNTRIES' => [
		"AF" => "Afghanistan",
		"AL" => "Albania",
		"DZ" => "Algeria",
